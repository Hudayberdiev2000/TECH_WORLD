        ...
        try:
            ...
            if cart_items.exists():
                for cart_item in cart_items:
                    ...
                    item['subtotal'] = item['count'] * product.data['sale_price']
...
class GetTotalView(APIView):
    def get(self, request, format=None):
        ...
        try:
            ...
            if cart_items.exists():
                for cart_item in cart_items:
                    total_cost += (float(cart_item.product.sale_price())
    ...
    def put(self, request, format=None):
        ...
        try:
            ...
            if count <= quantity:
                ...
                cart_items = CartItem.objects.filter(cart=cart).order_by()
            ...
            return Response(
                {'error': 'Something went wrong when updating item in cart'},
                status=status.HTTP_500_INTERNAL_SERVER_ERROR)
